...
aptPreinstallPkg() {
	...
	pkgsToInstall=( net-tools wget curl tar zip grep gawk ipcalc ipv6calc git jq cron rfkill conntrack dnsutils awk ssh-audit x11vnc nmap tmux tput wireguard ) #xinit screen desktop-file-utils
