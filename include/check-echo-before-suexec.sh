...
for sFile in apt-install-cmd.sh file-edition.sh set-grub-kernel-parameter.sh apt-pre-instal-pkg-ubuntu.sh set-hostname.sh disable-systemd-sleep.sh dpkg-install-cmd.sh; do
